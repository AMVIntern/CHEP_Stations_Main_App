...
public sealed class Station4DefectReportCsvOptions
{
	public const string SectionName = "Station4DefectReportCsv";

	public bool Enabled { get; init; } = true;

	public string RootFolder { get; init; } = @"C:\VisionAppLogs\Station4Defects";

	// Example: Station4_Report_Shift_1_29-Jan-2026.csv
